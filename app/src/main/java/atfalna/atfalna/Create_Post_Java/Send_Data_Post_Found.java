...
public class Send_Data_Post_Found extends StringRequest {
    ...
    public Send_Data_Post_Found(String scity, String sday, String smonth, String syear, String sgender, String sphone, String splace, String sinfo, String semail_us, Response.Listener<String> listener) {
